...
public:
  ...
  void debug(const __FlashStringHelper *scope, const __FlashStringHelper *label, unsigned long value)
  {
    Serial.print(scope);
    Serial.print(F(":: "));
    Serial.print(label);
  ...
  void debug(const __FlashStringHelper *scope, const __FlashStringHelper *label, unsigned long array[], int len)
  {
    Serial.print(scope);
    Serial.print(F(":: "));
    Serial.print(label);
